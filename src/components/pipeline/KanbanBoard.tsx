                    ...
                    {col.deals.length === 0 ? (
                      ...
                      col.deals.map(d => (
                        ...
                        <div
                          ...
                          style={{ width: 264, minWidth: 264, maxWidth: 264, height: 130, minHeight: 130, maxHeight: 130, backgroundColor: salesColorMap.get(d.salesId)?.bg || 'hsl(var(--card))', border: `1.5px solid ${salesColorMap.get(d.salesId)?.border || 'hsl(var(--border))'}` }}
