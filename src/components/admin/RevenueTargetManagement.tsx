...
import { Loader2, Save, Upload, Download, Plus, Trash2, DollarSign, TrendingUp, BarChart3, Users, Calendar, CalendarRange } from 'lucide-react';
    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap items-end gap-3">
        <div className="space-y-1">
          ...
          <Select value={viewMode} onValueChange={v => setViewMode(v as 'monthly' | 'annually')}>
