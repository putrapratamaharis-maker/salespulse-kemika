  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
        ...
        <KPICard label={`MY TOTAL TARGET ${now.getFullYear()}`} value={formatIDRFull(totalTargetYear)} icon={Target} autoFitText className="bg-kpi-amber " borderAccent="border-l-kpi-amber-border" tooltip={`Jumlah seluruh revenue_target Anda di tahun ${now.getFullYear()} dari Admin Panel Sales Targets (semua bulan & segmen)`} />
