...
-- Remove revenue_date column from deals
ALTER TABLE public.deals DROP COLUMN IF EXISTS revenue_date;

-- Update get_executive_summary_kpis to remove revenue_date reference
